...
export const FinalResults: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState<'results' | 'decisions'>('results');
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4 pointer-events-auto">
